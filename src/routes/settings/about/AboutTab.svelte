...
<div class="flex flex-col items-center py-4 px-4 max-w-5xl mx-auto">
      ...
      <Card.Content class="pt-8 pb-6 flex-1 flex items-center">
        <div class="flex flex-col items-center text-center space-y-4 w-full">
          ...
          <div class="animate-speedy {isJumping ? (clickCount >= 10 ? 'crazy-jumping' : `jumping-${jumpLevel}`) : ''} {hasClicked && !isJumping ? 'clicked' : ''}" onclick={handleLogoClick}>
            ...
            <!-- Easter Egg Popup -->
            {#if showEasterEgg}
              <div class="easter-egg-popup">Stop already, will you? Coming from r/selfhosted?</div>
            {/if}
          </div>
          ...
          <div class="flex items-center gap-4 text-xs text-muted-foreground">
            ...
            {#if serverUptime !== null}
              <div class="flex items-center gap-1 min-w-34">
                ...
                <div class="flex items-center gap-2 flex-wrap">
                  ...
                  {#if $licenseStore.licenseType === 'enterprise'}
                    <span class="text-amber-500 font-medium flex items-center gap-1">
                      <Crown class="size-4 fill-current" />
                      Enterprise
                    </span>
                  {:else if $licenseStore.licenseType === 'smb'}
            ...
            {#if systemInfo.docker}
              ...
              <div class="grid grid-cols-5 gap-2 pt-3">
                <div class="stat-box stat-box-blue">
                  <div class="stat-icon-wrapper bg-blue-500/10"><Box class="size-4 text-blue-500" /></div>
                ...
                <div class="stat-box stat-box-cyan">
                  <div class="stat-icon-wrapper bg-cyan-500/10"><Layers class="size-4 text-cyan-500" /></div>
                ...
                <div class="stat-box stat-box-purple">
                  <div class="stat-icon-wrapper bg-purple-500/10"><Images class="size-4 text-purple-500" /></div>
                ...
                <div class="stat-box stat-box-green">
                  <div class="stat-icon-wrapper bg-green-500/10"><HardDrive class="size-4 text-green-500" /></div>
                ...
                <div class="stat-box stat-box-orange">
                  <div class="stat-icon-wrapper bg-orange-500/10"><Network class="size-4 text-orange-500" /></div>
  ...
  <Card.Root class="w-full mt-4">
    <Tabs.Root bind:value={activeTab} class="w-full px-4">
      ...
      <Tabs.Content value="dependencies">
        <div class="relative w-full max-w-xs mb-3">
          ...
          <Input type="text" placeholder="Search packages or licenses..." class="text-xs pl-9" bind:value={depsSearch} />
        </div>
        ...
        {:else}
          <div class="max-h-[300px] overflow-y-auto overflow-x-hidden rounded-md border">
            <div class="grid grid-cols-[1fr_auto_auto_auto] gap-2 text-sm font-medium text-muted-foreground px-3 py-1 border-b sticky top-0 bg-muted">
              <div>Package</div>
            ...
            <div class="divide-y">
              {#each filteredDeps as dep}
                <div class="grid grid-cols-[1fr_auto_auto_auto] gap-2 text-xs px-3 py-1.5 hover:bg-muted/50 items-center">
                  <div class="font-mono truncate" title={dep.name}>{dep.name}</div>

                  <div class="w-20 text-center">
                    <Badge variant="outline" class="font-mono">{dep.version}</Badge>
                  </div>

                  <div class="w-24 text-center">
                    <Badge variant="secondary">{dep.license}</Badge>
                  </div>
